...
function buildScene(id){
  ...
  if (id === 'port'){
    ...
    ground(g, TONE, rnd, { w: 119, d: 95, amp: 1.0, flat: 44, ridge: 5.5, scatter: 22 });
  }
  ...
  if (id === 'datacenter'){
    ...
    ground(g, TONE, rnd, { w: 60, d: 55, amp: 0.8, flat: 30, ridge: 4.0, scatter: 16 });
  }
  ...
  if (id === 'wind'){
    ...
    ground(g, TONE, rnd, { w: 59, d: 48, plane: false, ridge: 6.0, scatter: 20 });
  }
  ...
  if (id === 'grid'){
    ground(g, TONE, rnd, { w: 63, d: 50, amp: 1.2, flat: 12, ridge: 7.0, scatter: 30 });
    const tops = [];
    for (let i=0;i<5;i++){
  ...
  if (id === 'urban'){
    ...
    ground(g, TONE, rnd, { w: 62, d: 53, amp: 0.9, flat: 36, ridge: 5.0, scatter: 18 });
  }
